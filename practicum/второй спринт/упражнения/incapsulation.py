class Employee:
    ...
    def __generate_employee_id(self):
        id_data = self.first_name + self.last_name + self.gender
        self._employee_id = hash(id_data)
...
class OfficeEmployee(Employee):
    ...
    def get_vacation_payment(self, vacation_days):
        ...
        self.vacation_payment = self.__salary / 60 * self.vacation_days
        return int(self.vacation_payment)


# Пример использования:
office_employee = OfficeEmployee(
    first_name='Иван', last_name='Иванов', gender='м', worker_class=2, salary=45000
)
...
print(
    f'''У сотрудника осталось
{remaining_days} дн. отпуска.'''
)
